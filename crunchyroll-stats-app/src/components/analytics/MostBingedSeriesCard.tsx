  ...
  return (
    <Card className="group relative h-full border-primary-500/25 bg-gradient-to-br from-[var(--card)] via-[var(--card)] to-primary-500/5 transition-all duration-300 hover:border-primary-500/45 hover:shadow-[0_0_60px_rgba(249,115,22,0.2)]">
      ...
      <CardHeader className="pb-3 text-center pt-6">
        ...
        <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">Episodes, hours, and days for your biggest binge.</p>
      </CardHeader>
      <CardContent className="space-y-4 text-center">
        {data ? (
          <>
            ...
            <p className="stat-number text-3xl text-primary-600 dark:text-primary-400">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="rounded-xl border border-primary-500/25 bg-gradient-to-br from-primary-500/10 via-[var(--card)] to-[var(--bg)] px-4 py-3">
                <p className="text-[0.65rem] font-semibold uppercase tracking-[0.25em] text-gray-500 dark:text-gray-400">Total Hours</p>
                <p className="mt-1 text-lg font-semibold text-primary-600 dark:text-primary-400">{formatHours(data.hours)}</p>
              </div>
              <div className="rounded-xl border border-primary-500/25 bg-gradient-to-br from-primary-500/10 via-[var(--card)] to-[var(--bg)] px-4 py-3">
                <p className="text-[0.65rem] font-semibold uppercase tracking-[0.25em] text-gray-500 dark:text-gray-400">Days Watched</p>
          ...
          <div className="rounded-xl border border-[var(--border)] bg-[var(--bg)] px-4 py-5">
            <p className="text-sm text-gray-500 dark:text-gray-400">No binge data captured yet.</p>
          </div>
        )}
      </CardContent>
    </Card>
