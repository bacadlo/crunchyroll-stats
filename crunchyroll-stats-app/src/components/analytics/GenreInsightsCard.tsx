  ...
  return (
    <Card className="group relative h-full border-primary-500/25 transition-all duration-300 hover:border-primary-500/45">
      ...
      <CardHeader className="pb-3 text-center pt-6">
        ...
        <p className="mt-1 text-sm text-gray-400">See what genres dominate your watch time.</p>
      </CardHeader>
      <CardContent className="space-y-4 text-center">
        ...
        <div className="mx-auto w-full max-w-sm text-left">
          <p className="mb-3 text-sm font-semibold text-gray-300">Top 3 Genres</p>
          <div className="space-y-2">
            {topGenres.length === 0 && (
              <p className="text-sm text-gray-400">No genre data available.</p>
            )}
