    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-[1fr_minmax(13rem,1fr)_minmax(13rem,1fr)_auto]">
        <select
          ...
          className="w-full rounded-lg border border-[var(--border)] bg-[var(--surface)] px-3 py-2 text-sm text-[var(--text)] focus:outline-none focus:ring-2 focus:ring-primary-500"
        ...
        <button
          ...
          className="rounded-lg border border-[var(--border)] bg-[var(--surface)] px-3 py-2 text-sm text-[var(--text-secondary)] transition-colors hover:bg-[var(--surface-hover)] disabled:cursor-not-allowed disabled:opacity-50"
        >
          Clear filters
        </button>
      </div>
