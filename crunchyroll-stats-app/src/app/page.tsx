    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 py-14 sm:px-6 sm:py-20">
        <div className="text-center max-w-3xl mx-auto">
          <h1 className="text-3xl font-bold text-[var(--text)] mb-6 leading-tight sm:text-5xl md:text-6xl">
            Track Your Anime Journey with{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-blue-600">
              CrunchyStats
            </span>
          </h1>
          <p className="text-base text-[var(--text-secondary)] mb-10 leading-relaxed sm:text-xl">
